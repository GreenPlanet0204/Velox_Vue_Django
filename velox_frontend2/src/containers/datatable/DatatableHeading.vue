    ...
    <b-colxx xxs="12">
      ...
      <div class="mb-2 mt-2">
        ...
        <b-collapse id="displayOptions" class="d-md-block">
          <div
            v-if="addRecordButton"
            class=" d-inline-block float-md-left mr-1 align-top"
          >
            <b-button-group>
              <i
                class="iconsminds-add-file action-icon"
                @click="onAddRecordClick"
              ></i>
            </b-button-group>
          </div>

          <div class="d-block d-md-inline-block pt-1 " style="height:1.5em">
            <div
              v-if="searchBox"
          ...
          <div class="float-md-right pt-1">
            ...
            >
              <b-dropdown-item
                v-for="(size, index) in pageSizesArray"
                :key="index"
...
export default {
  ...
  data() {
    return {
      pageSizesArray: this.pageSizes ? this.pageSizes : [10, 30, 50, 100]
    };
  },
  methods: {
    onAddRecordClick() {
